package com.bw30.zsch.tribe.touch.system.view;
...
public class MixedViewResolver implements ViewResolver {
	...
	private final static Logger logger = Logger.getLogger(MixedViewResolver.class);
	...
	public View resolveViewName(String viewName, Locale locale) throws Exception {
		...
		if (n == (-1))
			throw new Exception("No ViewResolver");
