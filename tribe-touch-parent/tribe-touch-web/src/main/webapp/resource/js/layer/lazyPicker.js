			...
			if(!p.params.data || typeof p.params.data === 'string') {
				...
				picker = '<div class="picker-selector"></div><div class="picker-wrapper">' +
										'<div class="picker-desc">' +
										   '<p class="picker-desc-info"><img src="../../resource/images/rlxr.png">' + 
										   		'<span class="text-info text-small">最多5人，成人儿童比例1:2</span>' + 
										   	'</p>' +
										   '<p class="clearfix picker-item-title">' + 
										   		'<span class="pull-left">成人(&ge;)12岁</span>' +
										   		'<span class="pull-right">儿童(2-12岁)</span>' +
										   '</p>' +	
										'</div>';
